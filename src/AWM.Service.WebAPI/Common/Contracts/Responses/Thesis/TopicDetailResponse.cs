...
public sealed record TopicApplicationResponse
{
    ...
    /// <summary>
    /// Date and time when student applied.
    /// </summary>
    /// <example>2024-01-20T09:00:00Z</example>
    public DateTime AppliedAt { get; init; }

    /// <summary>
    /// Date and time when application was reviewed (nullable).
    /// </summary>
    /// <example>2024-01-21T15:30:00Z</example>
    public DateTime? ReviewedAt { get; init; }

    /// <summary>
    /// User ID who reviewed the application (nullable).
    /// </summary>
    /// <example>5</example>
    ...
    /// </summary>
    /// <example>Approved after interview</example>
