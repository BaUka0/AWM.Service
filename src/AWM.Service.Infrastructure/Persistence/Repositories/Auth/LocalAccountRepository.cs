...
public sealed class LocalAccountRepository : ILocalAccountRepository
{
    ...
    public async Task<IReadOnlyList<LocalAccount>> GetAllAsync(CancellationToken cancellationToken = default)
    {
        return await _context.LocalAccounts.ToListAsync(cancellationToken);
    }
