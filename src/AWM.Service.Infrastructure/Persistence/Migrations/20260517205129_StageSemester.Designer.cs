...
namespace AWM.Service.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260517205129_StageSemester")]
    partial class StageSemester
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.Entities.RoleAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.Entities.RoleActionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.Entities.RoleOperation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.Entities.RoleOperationAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.Entities.UserAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.Entities.UserAccessHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.ViewModels.ReducedUserAccessMatrix", b =>
                {
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.ViewModels.RoleAccessMatrix", b =>
                {
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.ViewModels.UserAccessMatrix", b =>
                {
                    b.Property<string>("ActionTypeName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AWM.Service.Domain.CommonDomain.Entities.Semester", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Semesters", "Edu");
                });

            modelBuilder.Entity("AWM.Service.Domain.CommonDomain.Entities.SemesterType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AWM.Service.Domain.CommonDomain.Entities.Stage", b =>
                {
                    ...
                    b.HasIndex("DepartmentId", "SemesterId", "WorkflowStageId")
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.Entities.RoleOperation", b =>
                {
                    b.HasOne("AWM.Service.Domain.Auth.RbacPlus.Entities.RoleOperation", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.Entities.RoleOperationAction", b =>
                {
                    b.HasOne("AWM.Service.Domain.Auth.RbacPlus.Entities.RoleAccess", "RoleAccess")
                        .WithMany("OperationActions")
                        .HasForeignKey("RoleAccessId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AWM.Service.Domain.Auth.RbacPlus.Entities.RoleActionType", "RoleActionType")
                        .WithMany("OperationActions")
                        .HasForeignKey("RoleActionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AWM.Service.Domain.Auth.RbacPlus.Entities.RoleOperation", "RoleOperation")
                        .WithMany("OperationActions")
            ...
            modelBuilder.Entity("AWM.Service.Domain.Auth.RbacPlus.Entities.UserAccess", b =>
                {
                    ...
                    b.HasOne("AWM.Service.Domain.Auth.Entities.User", "User")
                        .WithMany("UserAccesses")
            ...
            modelBuilder.Entity("AWM.Service.Domain.CommonDomain.Entities.Semester", b =>
                {
                    b.HasOne("AWM.Service.Domain.CommonDomain.Entities.SemesterType", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AWM.Service.Domain.CommonDomain.Entities.Stage", b =>
                {
                    ...
                    b.HasOne("AWM.Service.Domain.CommonDomain.Entities.Semester", null)
                        .WithMany()
