...
public sealed class GetSupervisorsQueryHandler : IRequestHandler<GetSupervisorsQuery, Result<IReadOnlyList<EmployeeDto>>>
{
    ...
    public async Task<Result<IReadOnlyList<EmployeeDto>>> Handle(GetSupervisorsQuery request, CancellationToken cancellationToken)
    {
