...
public sealed class DeleteCriteriaCommandHandler : IRequestHandler<DeleteCriteriaCommand, Result>
{
    ...
    public async Task<Result> Handle(DeleteCriteriaCommand request, CancellationToken cancellationToken)
    {
