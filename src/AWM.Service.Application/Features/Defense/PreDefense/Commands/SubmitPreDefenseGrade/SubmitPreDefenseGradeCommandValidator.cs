...
/// <summary>
/// Validator for SubmitPreDefenseGradeCommand.
/// </summary>
public sealed class SubmitPreDefenseGradeCommandValidator : AbstractValidator<SubmitPreDefenseGradeCommand>
{
    public SubmitPreDefenseGradeCommandValidator()
    {
