...
public sealed class UpdateSupervisorWorkloadCommandHandler : IRequestHandler<UpdateSupervisorWorkloadCommand, Result<Unit>>
{
    private readonly IStaffAssignmentRepository _staffAssignmentRepository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ICurrentUserProvider _currentUserProvider;

    public UpdateSupervisorWorkloadCommandHandler(
    ...
    public async Task<Result<Unit>> Handle(UpdateSupervisorWorkloadCommand request, CancellationToken cancellationToken)
    {
